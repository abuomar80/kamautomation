...
st.set_page_config(
    page_title="Circulation Loans Import", layout="wide", initial_sidebar_state="expanded"
)

# Render login form and get connection status
connected, okapi_url, tenant_id, token, headers, _, _ = render_login_form(page_key_prefix="loans")
...
if __name__ == "__main__":
    if connected:
        ...
        st.info("👆 Please login to your tenant above to access the Circulation Loans Import tool.")
