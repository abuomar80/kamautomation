...
def upload_file():
    ...
    if st.session_state.profiling is not None:
        ...
        test_names = ["Material_Types", "Statistical_Codes", "Item_status", "User_groups", "Location", "Calendar", "Calendar Exceptions", "Department", "FeeFineOwner", "FeeFine", "Waives", "PaymentMethods", "Refunds"]
        match_state = []
        j = 0
